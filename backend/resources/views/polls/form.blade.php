...
<div class="max-w-2xl mx-auto flex flex-col gap-6">
    ...
    <h1 class="text-2xl font-bold">Criar Nova Enquete</h1>
    ...
    <form action="{{ route('polls.store') }}" method="POST" class="flex flex-col gap-4">
        @csrf
        <div>
        ...
        <div id="options-wrapper" class="flex flex-col gap-2">
            ...
            <input type="text" name="options[]" class="w-full border rounded px-3 py-2" placeholder="Opção 1" required>
            <input type="text" name="options[]" class="w-full border rounded px-3 py-2" placeholder="Opção 2" required>
